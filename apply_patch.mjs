...
if (code.includes(targetSearchSetup)) {
  ...
  console.log("Replaced search setup successfully!");
} else {
  console.log("targetSearchSetup not found");
}
...
if (code.includes(targetDashboardMatches)) {
  ...
  console.log("Replaced dashboard matches successfully!");
} else {
  console.log("targetDashboardMatches not found");
}
