  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* Right side: Cost toggle + account menu */}
        <div className="flex items-center gap-4 shrink-0 self-end md:self-auto">
          {/* Cost View Inline Switch (Consistent with style) */}
          <div className="flex items-center gap-2 rounded-xl px-2.5 py-1.5 border" style={{ borderColor: theme.colors.border, backgroundColor: theme.colors.backgroundTertiary || 'rgba(0,0,0,0.02)' }}>
            <DollarSign className="h-3.5 w-3.5" style={{ color: theme.colors.textMuted }} />
            <span className="text-xs font-medium" style={{ color: theme.colors.text }}>{showCost ? 'Cost View' : 'Selling Price'}</span>
            <Switch
              checked={showCost}
    ...
    <div className="p-8 lg:p-12 max-w-7xl mx-auto">
      ...
      <div className="mt-12 grid grid-cols-1 md:grid-cols-3 gap-6">
        <div className="rounded-2xl border p-6" style={{ backgroundColor: theme.colors.card || '#ffffff', borderColor: theme.colors.border }}>
          <p className="text-sm font-semibold uppercase tracking-wider" style={{ color: theme.colors.textMuted }}>Reports</p>
          <p className="text-3xl font-bold mt-1" style={{ color: theme.colors.text }}>2</p>
        </div>
        <div className="rounded-2xl border p-6" style={{ backgroundColor: theme.colors.card || '#ffffff', borderColor: theme.colors.border }}>
